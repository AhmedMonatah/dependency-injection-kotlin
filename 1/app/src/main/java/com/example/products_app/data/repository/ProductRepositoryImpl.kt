...
class ProductsRepositoryImpl private constructor(
   serviceLocator: ServiceLocator
    ...
    private val remoteDataSource = serviceLocator.getDependency<RemoteDataSource>(DEPENDANCY.REMOTE_SOURCE)
    private val localDataSource = serviceLocator.getDependency<LocalDataSource>(DEPENDANCY.LOCAL_SOURCE)
